...
// Creating the circleLayer - called Lazy Instantiation
...
// Method to ensure taht the circle animation is positioned properly
...
// Method that ensures our positioning is accurate
...
// Method that updates the postion of the layer if the frame changes
...
// Method that will recreate the circle layer anytime the radius changes
...
// Methods that will inform self.circleLayer if the other two properties change (stroke width or color)
...
// Setting some default values in the intializer and providing a hint about our size
