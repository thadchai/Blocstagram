...
// Sometimes you can infinite scroll, but there are no more older messages - Adding to prevent pointless requests
...
- (instancetype) init {
    ...
    if (self) {
        // Initialization of the operation manager in init
        ...
        // End of initializiation of the operation manager in init
...
#pragma mark - Getting Feed of Instagram User Images into a Dictionary
 ...
 - (void) populateDataWithParameters:(NSDictionary *)parameters completionHandler:(BLCNewItemCompletionBlock)completionHandler {
    if (self.accessToken) {
        ...
        // an implementation that uses AFNetworking
...
// Helper method that will reload the row
